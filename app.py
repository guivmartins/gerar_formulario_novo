# app.py - Construtor de Formulários 6.4 (estável) com Importação e Edição de XML
    ...
    for el in elementos_node.findall("elemento"):
        ...
        if tipo == "tabela":
            ...
            campos.append({
                ...
                "in_tabela": False,   # pré-visualização plana
...
# -------------------------
# Aba 2 - Importar / Editar XML
# -------------------------
with aba[1]:
    st.header("Importar / Editar XML")

    # Upload e carregar no estado
